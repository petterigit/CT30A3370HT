...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 5b 78 10 80 	movl   $0x8010785b,(%esp)
...
80100a72:	75 d2                	jne    80100a46 <exec+0x56>
  ...
  if((pgdir = setupkvm()) == 0)
80100a74:	e8 b7 61 00 00       	call   80106c30 <setupkvm>
...
80100b04:	e8 77 5f 00 00       	call   80106a80 <allocuvm>
...
80100b3a:	e8 81 5e 00 00       	call   801069c0 <loaduvm>
...
80100b59:	e8 52 60 00 00       	call   80106bb0 <freevm>
...
80100b95:	e8 e6 5e 00 00       	call   80106a80 <allocuvm>
...
80100bac:	e8 ff 5f 00 00       	call   80106bb0 <freevm>
...
80100bf1:	e8 da 60 00 00       	call   80106cd0 <clearpteu>
  sp = sz;
...
80100d2c:	e8 ff 5a 00 00       	call   80106830 <switchuvm>
  freevm(oldpgdir);
80100d31:	89 3c 24             	mov    %edi,(%esp)
80100d34:	e8 77 5e 00 00       	call   80106bb0 <freevm>
  return 0;
...
80101ea8:	68 42 76 10 80       	push   $0x80107642
...
80102e22:	e8 c9 28 00 00       	call   801056f0 <idtinit>
...
80102e43:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e46:	e8 c5 39 00 00       	call   80106810 <switchkvm>
  seginit();
80102e4b:	e8 c0 38 00 00       	call   80106710 <seginit>
  lapicinit();
...
80102ea9:	e8 32 2b 00 00       	call   801059e0 <uartinit>
  pinit();         // process table
80102eae:	e8 0d 08 00 00       	call   801036c0 <pinit>
  tvinit();        // trap vectors
80102eb3:	e8 98 27 00 00       	call   80105650 <tvinit>
  binit();         // buffer cache
...
80103624:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103627:	c7 40 14 42 56 10 80 	movl   $0x80105642,0x14(%eax)
...
801037c3:	e8 68 34 00 00       	call   80106c30 <setupkvm>
...
801037e1:	e8 5a 31 00 00       	call   80106940 <inituvm>
  p->sz = PGSIZE;
...
801038ce:	e8 ad 31 00 00       	call   80106a80 <allocuvm>
...
801038e0:	e8 4b 2f 00 00       	call   80106830 <switchuvm>
  return 0;
...
80103904:	e8 77 32 00 00       	call   80106b80 <deallocuvm>
...
80103958:	e8 a3 33 00 00       	call   80106d00 <copyuvm>
...
80103a9b:	83 c3 7c             	add    $0x7c,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103a9e:	e8 8d 2d 00 00       	call   80106830 <switchuvm>
      p->state = RUNNING;
...
80103ab0:	e8 c6 0b 00 00       	call   8010467b <swtch>
      switchkvm();
80103ab5:	e8 56 2d 00 00       	call   80106810 <switchkvm>
...
80103e80:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e87:	e8 24 2d 00 00       	call   80106bb0 <freevm>
        p->pid = 0;
...
80103feb:	68 5b 78 10 80       	push   $0x8010785b
...
80104820 <syscall>:
[SYS_getreadcount] sys_getreadcount // OWNCODE
};
...
801049c4:	68 38 76 10 80       	push   $0x80107638
...
801049dc:	68 37 76 10 80       	push   $0x80107637
...
801049f1:	68 2b 76 10 80       	push   $0x8010762b
...
801049fe:	68 3a 76 10 80       	push   $0x8010763a
...
80104a0b:	68 1c 76 10 80       	push   $0x8010761c
...
80104af5:	83 ec 18             	sub    $0x18,%esp
  ...
  READCOUNTER++; // OWNCODE
80104af8:	83 05 bc a5 10 80 01 	addl   $0x1,0x8010a5bc

  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104aff:	8d 55 ec             	lea    -0x14(%ebp),%edx
80104b02:	e8 19 ff ff ff       	call   80104a20 <argfd.constprop.0>
80104b07:	85 c0                	test   %eax,%eax
80104b09:	78 45                	js     80104b50 <sys_read+0x60>
80104b0b:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104b0e:	83 ec 08             	sub    $0x8,%esp
80104b11:	50                   	push   %eax
80104b12:	6a 02                	push   $0x2
80104b14:	e8 17 fc ff ff       	call   80104730 <argint>
80104b19:	83 c4 10             	add    $0x10,%esp
80104b1c:	85 c0                	test   %eax,%eax
80104b1e:	78 30                	js     80104b50 <sys_read+0x60>
...
80104b2c:	e8 4f fc ff ff       	call   80104780 <argptr>
80104b31:	83 c4 10             	add    $0x10,%esp
80104b34:	85 c0                	test   %eax,%eax
80104b36:	78 18                	js     80104b50 <sys_read+0x60>
    return -1;
  return fileread(f, p, n);
80104b38:	83 ec 04             	sub    $0x4,%esp
80104b3b:	ff 75 f0             	pushl  -0x10(%ebp)
80104b3e:	ff 75 f4             	pushl  -0xc(%ebp)
80104b41:	ff 75 ec             	pushl  -0x14(%ebp)
80104b44:	e8 07 c4 ff ff       	call   80100f50 <fileread>
...
80104e1d:	58                   	pop    %eax
80104e1e:	5a                   	pop    %edx
80104e1f:	68 38 76 10 80       	push   $0x80107638
...
80104e38:	68 37 76 10 80       	push   $0x80107637
...
80104f8d:	68 5c 76 10 80       	push   $0x8010765c
...
80104f9a:	68 6e 76 10 80       	push   $0x8010766e
...
80104fa7:	68 4a 76 10 80       	push   $0x8010764a
...
801054f1:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
}
...
80105664:	c6 04 c5 c4 4c 11 80 	movb   $0x0,-0x7feeb33c(,%eax,8)
8010566b:	00 
8010566c:	66 89 0c c5 c2 4c 11 	mov    %cx,-0x7feeb33e(,%eax,8)
80105673:	80 
80105674:	c6 04 c5 c5 4c 11 80 	movb   $0x8e,-0x7feeb33b(,%eax,8)
8010567b:	8e 
8010567c:	66 89 14 c5 c0 4c 11 	mov    %dx,-0x7feeb340(,%eax,8)
80105683:	80 
80105684:	c1 ea 10             	shr    $0x10,%edx
80105687:	66 89 14 c5 c6 4c 11 	mov    %dx,-0x7feeb33a(,%eax,8)
8010568e:	80 
void
tvinit(void)
{
...
801056a9:	68 7d 76 10 80       	push   $0x8010767d
801056ae:	68 80 4c 11 80       	push   $0x80114c80
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056b3:	66 89 15 c2 4e 11 80 	mov    %dx,0x80114ec2
801056ba:	c6 05 c4 4e 11 80 00 	movb   $0x0,0x80114ec4
801056c1:	66 a3 c0 4e 11 80    	mov    %ax,0x80114ec0
801056c7:	c1 e8 10             	shr    $0x10,%eax
801056ca:	c6 05 c5 4e 11 80 ef 	movb   $0xef,0x80114ec5
801056d1:	66 a3 c6 4e 11 80    	mov    %ax,0x80114ec6

  initlock(&tickslock, "time");
801056d7:	e8 e4 ea ff ff       	call   801041c0 <initlock>
}
...
801056fb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801056ff:	b8 c0 4c 11 80       	mov    $0x80114cc0,%eax
...
80105750:	e8 2b e0 ff ff       	call   80103780 <myproc>
...
80105773:	e8 e8 df ff ff       	call   80103760 <cpuid>
...
801057b2:	e8 c9 df ff ff       	call   80103780 <myproc>
...
801057d5:	e8 a6 df ff ff       	call   80103780 <myproc>
801057da:	85 c0                	test   %eax,%eax
801057dc:	74 0b                	je     801057e9 <trap+0xc9>
801057de:	e8 9d df ff ff       	call   80103780 <myproc>
...
8010582b:	75 a8                	jne    801057d5 <trap+0xb5>
    exit();
8010582d:	e8 7e e3 ff ff       	call   80103bb0 <exit>
...
8010583c:	75 ab                	jne    801057e9 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
8010583e:	e8 9d e4 ff ff       	call   80103ce0 <yield>
...
80105845:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105848:	e8 13 df ff ff       	call   80103760 <cpuid>
...
8010588f:	68 88 76 10 80       	push   $0x80107688
...
801058d1:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801058d4:	e8 47 ef ff ff       	call   80104820 <syscall>
    if(myproc()->killed)
...
801058ef:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
801058f0:	e9 bb e2 ff ff       	jmp    80103bb0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
801058f8:	e8 b3 e2 ff ff       	call   80103bb0 <exit>
...
80105908:	e8 13 ea ff ff       	call   80104320 <acquire>
      ticks++;
      wakeup(&ticks);
8010590d:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105914:	83 05 c0 54 11 80 01 	addl   $0x1,0x801154c0
      wakeup(&ticks);
8010591b:	e8 c0 e5 ff ff       	call   80103ee0 <wakeup>
      release(&tickslock);
80105920:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
80105927:	e8 a4 ea ff ff       	call   801043d0 <release>
...
8010593a:	e8 21 de ff ff       	call   80103760 <cpuid>
...
80105948:	68 ac 76 10 80       	push   $0x801076ac
8010594d:	e8 0e ad ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105952:	83 c4 14             	add    $0x14,%esp
80105955:	68 82 76 10 80       	push   $0x80107682
...
801059b5:	e8 76 cd ff ff       	call   80102730 <microdelay>
{
  int i;
...
80105a4f:	bb a4 77 10 80       	mov    $0x801077a4,%ebx
...
80106566:	89 d3                	mov    %edx,%ebx
  ...
  pde = &pgdir[PDX(va)];
80106568:	c1 ea 16             	shr    $0x16,%edx
...
8010656e:	83 ec 0c             	sub    $0xc,%esp
  ...
  pde = &pgdir[PDX(va)];
  if(*pde & PTE_P){
80106571:	8b 07                	mov    (%edi),%eax
80106573:	a8 01                	test   $0x1,%al
80106575:	74 29                	je     801065a0 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106577:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010657c:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
...
80106582:	8d 65 f4             	lea    -0xc(%ebp),%esp
  ...
  return &pgtab[PTX(va)];
80106585:	c1 eb 0a             	shr    $0xa,%ebx
80106588:	81 e3 fc 0f 00 00    	and    $0xffc,%ebx
8010658e:	8d 04 1e             	lea    (%esi,%ebx,1),%eax
}
80106591:	5b                   	pop    %ebx
80106592:	5e                   	pop    %esi
80106593:	5f                   	pop    %edi
...
801065ba:	e8 61 de ff ff       	call   80104420 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
801065bf:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
801065c5:	83 c4 10             	add    $0x10,%esp
801065c8:	83 c8 07             	or     $0x7,%eax
801065cb:	89 07                	mov    %eax,(%edi)
801065cd:	eb b3                	jmp    80106582 <walkpgdir+0x22>
801065cf:	90                   	nop
  }
  return &pgtab[PTX(va)];
}
...
8010665d:	68 ac 77 10 80       	push   $0x801077ac
...
80106702:	68 46 71 10 80       	push   $0x80107146
...
80106713:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106716:	e8 45 d0 ff ff       	call   80103760 <cpuid>
...
80106728:	66 89 90 18 28 11 80 	mov    %dx,-0x7feed7e8(%eax)
8010672f:	66 89 88 1a 28 11 80 	mov    %cx,-0x7feed7e6(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106736:	ba ff ff ff ff       	mov    $0xffffffff,%edx
8010673b:	31 c9                	xor    %ecx,%ecx
8010673d:	66 89 90 20 28 11 80 	mov    %dx,-0x7feed7e0(%eax)
...
80106744:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106749:	66 89 88 22 28 11 80 	mov    %cx,-0x7feed7de(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106750:	31 c9                	xor    %ecx,%ecx
80106752:	66 89 90 28 28 11 80 	mov    %dx,-0x7feed7d8(%eax)
80106759:	66 89 88 2a 28 11 80 	mov    %cx,-0x7feed7d6(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106760:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106765:	31 c9                	xor    %ecx,%ecx
80106767:	66 89 90 30 28 11 80 	mov    %dx,-0x7feed7d0(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010676e:	c6 80 1c 28 11 80 00 	movb   $0x0,-0x7feed7e4(%eax)
static inline void
...
8010677a:	c6 80 1d 28 11 80 9a 	movb   $0x9a,-0x7feed7e3(%eax)
80106781:	c6 80 1e 28 11 80 cf 	movb   $0xcf,-0x7feed7e2(%eax)
80106788:	c6 80 1f 28 11 80 00 	movb   $0x0,-0x7feed7e1(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010678f:	c6 80 24 28 11 80 00 	movb   $0x0,-0x7feed7dc(%eax)
80106796:	c6 80 25 28 11 80 92 	movb   $0x92,-0x7feed7db(%eax)
8010679d:	c6 80 26 28 11 80 cf 	movb   $0xcf,-0x7feed7da(%eax)
801067a4:	c6 80 27 28 11 80 00 	movb   $0x0,-0x7feed7d9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801067ab:	c6 80 2c 28 11 80 00 	movb   $0x0,-0x7feed7d4(%eax)
801067b2:	c6 80 2d 28 11 80 fa 	movb   $0xfa,-0x7feed7d3(%eax)
801067b9:	c6 80 2e 28 11 80 cf 	movb   $0xcf,-0x7feed7d2(%eax)
801067c0:	c6 80 2f 28 11 80 00 	movb   $0x0,-0x7feed7d1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801067c7:	66 89 88 32 28 11 80 	mov    %cx,-0x7feed7ce(%eax)
801067ce:	c6 80 34 28 11 80 00 	movb   $0x0,-0x7feed7cc(%eax)
801067d5:	c6 80 35 28 11 80 f2 	movb   $0xf2,-0x7feed7cb(%eax)
801067dc:	c6 80 36 28 11 80 cf 	movb   $0xcf,-0x7feed7ca(%eax)
801067e3:	c6 80 37 28 11 80 00 	movb   $0x0,-0x7feed7c9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
801067ea:	05 10 28 11 80       	add    $0x80112810,%eax
...
80106810:	a1 c4 54 11 80       	mov    0x801154c4,%eax
...
80106854:	0f 84 c4 00 00 00    	je     8010691e <switchuvm+0xee>
  ...
  pushcli();
8010685a:	e8 e1 d9 ff ff       	call   80104240 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010685f:	e8 7c ce ff ff       	call   801036e0 <mycpu>
80106864:	89 c3                	mov    %eax,%ebx
80106866:	e8 75 ce ff ff       	call   801036e0 <mycpu>
8010686b:	89 c7                	mov    %eax,%edi
8010686d:	e8 6e ce ff ff       	call   801036e0 <mycpu>
80106872:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106875:	83 c7 08             	add    $0x8,%edi
80106878:	e8 63 ce ff ff       	call   801036e0 <mycpu>
...
801068b9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
801068be:	e8 1d ce ff ff       	call   801036e0 <mycpu>
801068c3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801068ca:	e8 11 ce ff ff       	call   801036e0 <mycpu>
...
801068e6:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801068e9:	e8 f2 cd ff ff       	call   801036e0 <mycpu>
...
8010690b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010690c:	e9 6f d9 ff ff       	jmp    80104280 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106914:	68 b2 77 10 80       	push   $0x801077b2
...
80106921:	68 dd 77 10 80       	push   $0x801077dd
...
8010692e:	68 c8 77 10 80       	push   $0x801077c8
...
8010696f:	e8 ac da ff ff       	call   80104420 <memset>
...
801069a0:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
801069a1:	e9 2a db ff ff       	jmp    801044d0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
801069a9:	68 f1 77 10 80       	push   $0x801077f1
...
80106a5d:	68 0b 78 10 80       	push   $0x8010780b
...
80106a6a:	68 ac 78 10 80       	push   $0x801078ac
...
80106a8e:	0f 88 ca 00 00 00    	js     80106b5e <allocuvm+0xde>
    return 0;
  if(newsz < oldsz)
...
80106a97:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
80106a9a:	0f 82 82 00 00 00    	jb     80106b22 <allocuvm+0xa2>
    return oldsz;
...
80106aac:	39 df                	cmp    %ebx,%edi
80106aae:	77 43                	ja     80106af3 <allocuvm+0x73>
80106ab0:	e9 bb 00 00 00       	jmp    80106b70 <allocuvm+0xf0>
...
80106abb:	68 00 10 00 00       	push   $0x1000
80106ac0:	6a 00                	push   $0x0
80106ac2:	50                   	push   %eax
80106ac3:	e8 58 d9 ff ff       	call   80104420 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106ac8:	58                   	pop    %eax
80106ac9:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106acf:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106ad4:	5a                   	pop    %edx
80106ad5:	6a 06                	push   $0x6
80106ad7:	50                   	push   %eax
80106ad8:	89 da                	mov    %ebx,%edx
80106ada:	8b 45 08             	mov    0x8(%ebp),%eax
80106add:	e8 fe fa ff ff       	call   801065e0 <mappages>
80106ae2:	83 c4 10             	add    $0x10,%esp
80106ae5:	85 c0                	test   %eax,%eax
80106ae7:	78 47                	js     80106b30 <allocuvm+0xb0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80106aef:	39 df                	cmp    %ebx,%edi
80106af1:	76 7d                	jbe    80106b70 <allocuvm+0xf0>
    mem = kalloc();
80106af3:	e8 98 b9 ff ff       	call   80102490 <kalloc>
    if(mem == 0){
80106af8:	85 c0                	test   %eax,%eax
  ...
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
80106afa:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106afc:	75 ba                	jne    80106ab8 <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
80106afe:	83 ec 0c             	sub    $0xc,%esp
80106b01:	68 29 78 10 80       	push   $0x80107829
80106b06:	e8 55 9b ff ff       	call   80100660 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
...
80106b0e:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106b11:	76 4b                	jbe    80106b5e <allocuvm+0xde>
80106b13:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106b16:	8b 45 08             	mov    0x8(%ebp),%eax
80106b19:	89 fa                	mov    %edi,%edx
80106b1b:	e8 50 fb ff ff       	call   80106670 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106b33:	68 41 78 10 80       	push   $0x80107841
...
80106b40:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106b43:	76 0d                	jbe    80106b52 <allocuvm+0xd2>
80106b45:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106b48:	8b 45 08             	mov    0x8(%ebp),%eax
80106b4b:	89 fa                	mov    %edi,%edx
80106b4d:	e8 1e fb ff ff       	call   80106670 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106b55:	56                   	push   %esi
80106b56:	e8 85 b7 ff ff       	call   801022e0 <kfree>
      return 0;
...
80106b90:	5d                   	pop    %ebp
80106b91:	e9 da fa ff ff       	jmp    80106670 <deallocuvm.part.0>
...
80106bc9:	e8 a2 fa ff ff       	call   80106670 <deallocuvm.part.0>
...
80106bfe:	e8 dd b6 ff ff       	call   801022e0 <kfree>
...
80106c13:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106c14:	e9 c7 b6 ff ff       	jmp    801022e0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
80106c21:	e8 4a 97 ff ff       	call   80100370 <panic>
...
80106c35:	e8 56 b8 ff ff       	call   80102490 <kalloc>
80106c3a:	85 c0                	test   %eax,%eax
80106c3c:	74 6a                	je     80106ca8 <setupkvm+0x78>
    return 0;
...
80106c50:	e8 cb d7 ff ff       	call   80104420 <memset>
...
80106c6b:	e8 70 f9 ff ff       	call   801065e0 <mappages>
...
80106c84:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106c87:	5b                   	pop    %ebx
80106c88:	5e                   	pop    %esi
80106c89:	5d                   	pop    %ebp
80106c8a:	c3                   	ret    
...
80106c94:	e8 17 ff ff ff       	call   80106bb0 <freevm>
      return 0;
80106c99:	83 c4 10             	add    $0x10,%esp
    }
  return pgdir;
}
80106c9c:	8d 65 f8             	lea    -0x8(%ebp),%esp
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0) {
...
80106caa:	eb d8                	jmp    80106c84 <setupkvm+0x54>
...
80106cbb:	a3 c4 54 11 80       	mov    %eax,0x801154c4
...
80106cde:	e8 7d f8 ff ff       	call   80106560 <walkpgdir>
  if(pte == 0)
...
80106cf4:	e8 77 96 ff ff       	call   80100370 <panic>
...
80106d13:	0f 84 c5 00 00 00    	je     80106dde <copyuvm+0xde>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106d19:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106d1c:	85 c9                	test   %ecx,%ecx
80106d1e:	0f 84 9c 00 00 00    	je     80106dc0 <copyuvm+0xc0>
...
80106d40:	e8 8b d7 ff ff       	call   801044d0 <memmove>
...
80106d5b:	e8 80 f8 ff ff       	call   801065e0 <mappages>
80106d60:	83 c4 10             	add    $0x10,%esp
80106d63:	85 c0                	test   %eax,%eax
80106d65:	78 69                	js     80106dd0 <copyuvm+0xd0>
  uint pa, i, flags;
  char *mem;
...
80106dd4:	e8 07 b5 ff ff       	call   801022e0 <kfree>
      goto bad;
80106dd9:	83 c4 10             	add    $0x10,%esp
80106ddc:	eb c5                	jmp    80106da3 <copyuvm+0xa3>
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
80106dde:	31 c0                	xor    %eax,%eax
80106de0:	eb d1                	jmp    80106db3 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80106de5:	68 92 78 10 80       	push   $0x80107892
...
80106df2:	68 78 78 10 80       	push   $0x80107878
...
80106e0e:	e8 4d f7 ff ff       	call   80106560 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106e7f:	e8 4c d6 ff ff       	call   801044d0 <memmove>
    len -= n;
    buf += n;
