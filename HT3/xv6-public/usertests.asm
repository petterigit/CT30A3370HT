...
sbrktest(void)
{
  ...
  oldbrk = sbrk(0);
    ...
    2d42:	e8 eb 0b 00 00       	call   3932 <sbrk>
  ...
  // can one sbrk() less than a page?
  a = sbrk(0);
    2d51:	e8 dc 0b 00 00       	call   3932 <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d63:	6a 01                	push   $0x1
    2d65:	e8 c8 0b 00 00       	call   3932 <sbrk>
    if(b != a){
  ...
  c = sbrk(1);
    2d9b:	6a 01                	push   $0x1
    2d9d:	e8 90 0b 00 00       	call   3932 <sbrk>
  c = sbrk(1);
    2da2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2da9:	e8 84 0b 00 00       	call   3932 <sbrk>
  if(c != a + 1){
...
#define BIG (100*1024*1024)
  a = sbrk(0);
    ...
    2dc9:	6a 00                	push   $0x0
    2dcb:	e8 62 0b 00 00       	call   3932 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2ddc:	e8 51 0b 00 00       	call   3932 <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2df6:	6a 00                	push   $0x0
    2df8:	e8 35 0b 00 00       	call   3932 <sbrk>
  c = sbrk(-4096);
  ...
  *lastaddr = 99;
  ...
  c = sbrk(-4096);
    2e06:	e8 27 0b 00 00       	call   3932 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e1a:	6a 00                	push   $0x0
    2e1c:	e8 11 0b 00 00       	call   3932 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e35:	6a 00                	push   $0x0
    2e37:	e8 f6 0a 00 00       	call   3932 <sbrk>
    2e3c:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e3e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    2e45:	e8 e8 0a 00 00       	call   3932 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e5a:	6a 00                	push   $0x0
    2e5c:	e8 d1 0a 00 00       	call   3932 <sbrk>
  ...
  a = sbrk(0);
    ...
    2e82:	6a 00                	push   $0x0
    2e84:	e8 a9 0a 00 00       	call   3932 <sbrk>
  ...
  c = sbrk(4096);
    ...
    2f3b:	e8 f2 09 00 00       	call   3932 <sbrk>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f70:	6a 00                	push   $0x0
    2f72:	e8 bb 09 00 00       	call   3932 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2ff0:	e8 45 09 00 00       	call   393a <sleep>
...
void argptest()
{
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    35ef:	6a 00                	push   $0x0
    35f1:	e8 3c 03 00 00       	call   3932 <sbrk>
...
0000392a <getreadcount>:
SYSCALL(getreadcount) //OWN CODE
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3c8e:	53                   	push   %ebx
    3c8f:	e8 9e fc ff ff       	call   3932 <sbrk>
  if(p == (char*)-1)
